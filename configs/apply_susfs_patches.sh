...
if [ -f kernel/feature/adb_root.c.rej ]; then
  ...
  if grep -Fq 'setup_ld_preload(envp_user_ptr)' kernel/feature/adb_root.c.rej || \
     grep -Fq 'do_ksu_adb_root_handle_execveat' kernel/feature/adb_root.c.rej || \
     grep -Fq 'ksu_adb_root_handle_execveat(const char *filename, void ***envp_user_ptr)' kernel/feature/adb_root.c.rej || \
     grep -qE 'ksu_handle_vfs_fstat|ksu_execve_hook_ksud|ksu_execveat_hook_ksud|ksu_execve_hook_ksud_common' kernel/feature/adb_root.c.rej; then
